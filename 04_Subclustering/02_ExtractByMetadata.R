...
## Input parameters ===============================================================================
FILES_KEEP <- c(1) #comma separated file ID's
...
EXTRACT.OUT.FILENAME <- "Concat_Transformed_P0_11_F.csv"
LAYOUT.OUT.FILENAME <- "UMAP_layout_P0_11_F.csv"
CLUSTERS.OUT.FILENAME <- "clusters_P0_11_F.csv"
