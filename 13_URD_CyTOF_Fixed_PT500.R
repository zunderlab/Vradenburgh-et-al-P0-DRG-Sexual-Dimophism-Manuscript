...
CONCATTRANSFORMED.URD.FILENAME <- "/Concat_Transformed_URD.csv" #.txt file for URD
...
output.dir <- paste0(OUTPUT.FOLDER,"/",substr(time.now,start=1,stop=10),"_",
                     ...
                     substr(time.now,start=18,stop=19),"_URD_PT500")
#make output folder
...
#Calculate pseudotime
pseudotime.out <- floodPseudotime(URD_Object,root.cells, n=500, minimum.cells.flooded = 2, verbose=F)
