...
## Note: Runs with Pipeline2 outputs converted using 00_URD_Prep.R 
...
METADATA.FILENAME <- "/metadata_downsample.csv"
CONCAT.TRANSFORMED.FILENAME <- "/Concat_Transformed.csv"
LAYOUT.FILENAME <- "/UMAP_layout.csv"
CLUSTERS.FILENAME <- "/clusters.csv"
FILENUMS.FILENAME <- "filenums.csv" #The last column of the concat_transformed.csv
...
## Copy of Needed ZunderPipelineFunctions so don't have to load in Rivanna (workaround)
#' Metadata file input
#'
...
print("End 01_Downsample_By_Metadata_And_Cluster_CustomValues.R")
